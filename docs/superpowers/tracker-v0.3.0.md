...
| S2 — Onboarding wizard | `005-onboarding-wizard` | `plans/2026-04-15-s2-onboarding-wizard.md` | **Complete** — T1–T13 done |
| S4 — Observation CLI | `007-observation-cli` | `plans/2026-04-15-s4-observation-cli.md` | **Complete** — T1–T9 done |
| S5 — Multi-project dashboard | `008-multiproject-dashboard` | `plans/2026-04-15-s5-multiproject-dashboard.md` | **Complete** — T1–T13 done |
