...
describe('WorkflowGraph', () => {
  ...
  describe('addNode', () => {
    ...
    it('throws on duplicate node ID', () => {
      const g = new WorkflowGraph();
      g.addNode(makeNode({ id: 'a' }));
      expect(() => g.addNode(makeNode({ id: 'a' }))).toThrow(
  ...
  describe('updateNode', () => {
    ...
    it('throws when updating a non-existent node', () => {
      const g = new WorkflowGraph();
      expect(() => g.updateNode('missing', { title: 'x' })).toThrow(
  ...
  describe('addEdge', () => {
    ...
    it('rejects duplicate edges', () => {
      ...
      g.addNode(makeNode({ id: 'b' }));
      g.addEdge(makeEdge('a', 'b'));
      expect(() => g.addEdge(makeEdge('a', 'b'))).toThrow(
    ...
    it('rejects edges from a missing source node', () => {
      const g = new WorkflowGraph();
      g.addNode(makeNode({ id: 'b' }));
      expect(() => g.addEdge(makeEdge('missing', 'b'))).toThrow(
    ...
    it('rejects edges to a missing target node', () => {
      const g = new WorkflowGraph();
      g.addNode(makeNode({ id: 'a' }));
      expect(() => g.addEdge(makeEdge('a', 'missing'))).toThrow(
