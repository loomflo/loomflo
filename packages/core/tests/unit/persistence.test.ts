...
describe('appendEvent', () => {
  ...
  it('appends multiple events as separate lines', async () => {
    ...
    const e3 = makeEvent({ type: 'node_started', nodeId: 'node-1', ts: '2026-03-24T10:02:00.000Z' });
...
describe('queryEvents', () => {
  ...
  it('filters by single type', async () => {
    ...
    await appendEvent(tmpDir, makeEvent({ type: 'workflow_started', ts: '2026-03-24T10:01:00.000Z' }));
    await appendEvent(tmpDir, makeEvent({ type: 'node_started', nodeId: 'n1', ts: '2026-03-24T10:02:00.000Z' }));
  ...
  it('filters by nodeId', async () => {
    await appendEvent(tmpDir, makeEvent({ type: 'workflow_created' }));
    await appendEvent(tmpDir, makeEvent({ type: 'node_started', nodeId: 'n1', ts: '2026-03-24T10:01:00.000Z' }));
    await appendEvent(tmpDir, makeEvent({ type: 'node_started', nodeId: 'n2', ts: '2026-03-24T10:02:00.000Z' }));
  ...
  it('filters by agentId', async () => {
    await appendEvent(tmpDir, makeEvent({ type: 'agent_created', agentId: 'looma-1', ts: '2026-03-24T10:00:00.000Z' }));
    await appendEvent(tmpDir, makeEvent({ type: 'agent_created', agentId: 'looma-2', ts: '2026-03-24T10:01:00.000Z' }));
  ...
  it('applies limit (takes from end)', async () => {
    await appendEvent(tmpDir, makeEvent({ ts: '2026-03-24T08:00:00.000Z', type: 'workflow_created' }));
    await appendEvent(tmpDir, makeEvent({ ts: '2026-03-24T09:00:00.000Z', type: 'workflow_started' }));
    await appendEvent(tmpDir, makeEvent({ ts: '2026-03-24T10:00:00.000Z', type: 'node_started', nodeId: 'n1' }));
    await appendEvent(tmpDir, makeEvent({ ts: '2026-03-24T11:00:00.000Z', type: 'node_completed', nodeId: 'n1' }));
  ...
  it('combines multiple filters', async () => {
    await appendEvent(tmpDir, makeEvent({ ts: '2026-03-24T08:00:00.000Z', type: 'node_started', nodeId: 'n1' }));
    await appendEvent(tmpDir, makeEvent({ ts: '2026-03-24T09:00:00.000Z', type: 'node_started', nodeId: 'n2' }));
    await appendEvent(tmpDir, makeEvent({ ts: '2026-03-24T10:00:00.000Z', type: 'node_completed', nodeId: 'n1' }));
    await appendEvent(tmpDir, makeEvent({ ts: '2026-03-24T11:00:00.000Z', type: 'node_started', nodeId: 'n1' }));
